...
parser.add_argument('--reg_gmf', type=float, default=0.25)
...
parser.add_argument('--latent_dim_gmf', type=int, default=4)
parser.add_argument('--num_negative', type=int, default=4)
parser.add_argument('--layers', type=str, default='64, 32, 16')
...
for round in range(config['num_round']):
    ...
    engine.fed_train_a_round(all_train_data, round_id=round)
    # break
